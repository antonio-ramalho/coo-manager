package com.manager.coopafi.contractModule.services;

import com.manager.coopafi.contractModule.entities.Contract;
import com.manager.coopafi.contractModule.entities.ContractedProduct;
import com.manager.coopafi.contractModule.entities.FarmerContract;
import com.manager.coopafi.contractModule.repositories.ContractRepository;
...
import com.manager.coopafi.contractModule.enums.ParticipationLimitRule;
import com.manager.coopafi.contractModule.enums.ProductDeliveryRule;
import com.manager.coopafi.infrastructure.exceptions.DomainException;
import com.manager.coopafi.personModule.repositories.AgriculturalProductRepository;
...
public class ContractService {
    ...
    private void instantiateConsumerUnits(Contract contract, List<ContractConsumerInsertDto> dtoList) {
        for (ContractConsumerInsertDto dto : dtoList) {
            ConsumerUnit unit = consumerUnitRepository.findByStatusAndId(Status.ACTIVE, dto.consumerId())
    ...
    private void instantiateFarmerContracts(Contract contract, List<FarmerContractInsertDto> dtoList) {
        for (FarmerContractInsertDto dto : dtoList) {
            Farmer farmer = farmerRepository.findByStatusAndId(Status.ACTIVE, dto.farmerId())
