package com.manager.coopafi.contractModule.entities;
...
public class Contract implements Serializable {
    ...
    public FarmerContract addFarmerParticipation(Farmer farmer, Price specificCota) {
        ...
        if (alreadyExists) {
            throw new DomainException("O agricultor " + farmer.getPerson().getLegalName() + " já está vinculado a este contrato.");
        }
