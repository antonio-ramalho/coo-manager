...
import com.manager.coopafi.personModule.services.FarmerService;
...
public class FarmerResources {
    ...
    @GetMapping
    public ResponseEntity<List<FarmerMinDto>> findAllByStatus() {
        List <FarmerMinDto> list = service.findAllByStatus();
